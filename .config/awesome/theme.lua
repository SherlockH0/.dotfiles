...
theme.font          = "FantasqueSansM Nerd Font Mono 10"
...
theme.snap_shape = function(cr,w,h) gears.shape.rounded_rect(cr,w,h, 1) end
...
theme.menu_font = "FantasqueSansM Nerd Font Mono 14"
theme.menu_submenu = " "
